---
name: setup-bee-mode
description: Install this skills collection into every harness on this machine and discover which models the account can actually reach. Use for /setup-bee-mode, "set up bee-mode", "which models do I have", "scan my routes", or before any multi-model dispatch.
---
...
```bash
ls ~/.agents/skills/setup-bee-mode   # a symlink points at the clone
readlink -f ~/.agents/skills/setup-bee-mode
```
