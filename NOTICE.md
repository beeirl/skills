...
This collection mixes original skills with copies and adaptations of public
...
- Skills in this collection: codebase-design, code-review, diagnosing-bugs,
  domain-modeling, grill-with-docs, grilling, handoff, improve-codebase-architecture,
  prototype, research, resolving-merge-conflicts, tdd, to-tickets, writing-for-agents.
...
- Neither book is reprinted here.
